...
namespace OandaApi
{
    ...
    public class Oanda
    {
        ...
        static string s_apiServer = "https://api-fxtrade.oanda.com/";
        ...
        public static Account GetAccount()
        {
            ...
            JavaScriptSerializer serializer = new JavaScriptSerializer();
            Account tradeResponse = serializer.Deserialize<Account>(responseString);
           // List<Account> trades = new List<Account>();
        ...
        private static string MakeRequest(string requestString, string method = "GET", string postData = null)
        {
            ...
            var accessToken = "7e3276b2d770a29889ae5a48aaa7a09a-ee6d2ab94f1f443ec38b90ae38a22cb0";
